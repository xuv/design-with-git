...
, _convertNodes: function(nodes, context, level, store, block) {
    ...
    for (i = 0, l = nodes.length; i < l; i++) {
      ...
      /* Processing Attrs and removing Inkscape console */

      //attrs.dir(attrs)

      for (n = attrs.length - 1; n >= 0; n--) {
          if ( attrs[n].nodeName.indexOf('inkscape', 0) < 0 &&
               attrs[n].nodeName.indexOf('sodipodi', 0) < 0) {
      ...
      switch(type) {
        ...
        case 'xmlns:sodipodi':
        case 'xmlns:inkscape':
        case 'inkscape:version':
        case 'sodipodi:docname':
          // do nothing
        break
        */
        case 'rect':
